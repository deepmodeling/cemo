...
def test():
    f_in_mrcs = os.path.join("..", "data", "one_snr1000_no-ctf_2_gaussian_shift.mrcs")
    f_in_cs = os.path.join("..", "data", "one_snr1000_no-ctf_2_gaussian_shift.cs")
    f_out_mrcs = os.path.join("tmp", "one_snr1000_no-ctf_2_gaussian_shift_undo.mrcs")
    f_out_cs = os.path.join("tmp", "one_snr1000_no-ctf_2_gaussian_shift_undo.cs")
